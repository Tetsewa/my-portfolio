      ...
      <div className="flex flex-col md:block">
        ...
        <div className="w-full md:w-auto">
          <p className="text-lg text-gray-700 mb-4 text-justify">
            I'm a fullstack web developer with a preference for <strong>frontend development </strong>, based in the Netherlands and loves to create responsive, and visually stunning web experiences.
